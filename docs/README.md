...
#### Use the API
1. **[Update Complete](UPDATE_COMPLETE.md)** - Start here for overview ⚡ **NEW**
2. **[Archu API Quick Reference](ARCHU_API_QUICK_REFERENCE.md)** - Quick endpoint reference ⚡ **NEW**
3. **[Archu API Documentation](ARCHU_API_DOCUMENTATION.md)** - Complete guide ⚡ **NEW**
4. **[API Comparison Guide](API_COMPARISON_GUIDE.md)** - Compare APIs ⚡ **NEW**
...
3. **[Database Seeding Guide](DATABASE_SEEDING_GUIDE.md)** - Initialize roles and admin user ⚡
4. **[Password Policy Guide](PASSWORD_POLICY_GUIDE.md)** - Configure password requirements ⚡
...
3. **[API Comparison Guide](API_COMPARISON_GUIDE.md)** - API architecture ⚡ **NEW**
...
1. **[Update Complete](UPDATE_COMPLETE.md)** - Latest updates overview ⚡ **NEW**
2. [Architecture Guide](ARCHITECTURE.md)
3. [Quick Start](../README.md#quick-start)
4. **[JWT Quick Start](JWT_QUICK_START.md)** ⚡
5. **[Archu API Quick Reference](ARCHU_API_QUICK_REFERENCE.md)** ⚡ **NEW**
6. [Adding New Entities](../src/README_NEW_ENTITY.md)

### For Frontend Developers
API integration and usage:
1. **[API Comparison Guide](API_COMPARISON_GUIDE.md)** - Choose the right API ⚡ **NEW**
2. **[Archu API Documentation](ARCHU_API_DOCUMENTATION.md)** - Complete guide ⚡ **NEW**
3. **[Archu API Quick Reference](ARCHU_API_QUICK_REFERENCE.md)** - Quick lookups ⚡ **NEW**
4. HTTP Examples: `src/Archu.Api/Archu.Api.http` ⚡ **NEW**

### For Backend Developers
Implementation and architecture:
1. **[OpenAPI Update Summary](OPENAPI_UPDATE_SUMMARY.md)** - Technical details ⚡ **NEW**
2. [Architecture Guide](ARCHITECTURE.md)
3. **[API Comparison Guide](API_COMPARISON_GUIDE.md)** - API design ⚡ **NEW**
4. [Adding New Entities](../src/README_NEW_ENTITY.md)

### For Administrators
System management:
1. **[Admin API Quick Reference](ADMIN_API_QUICK_REFERENCE.md)** - Admin operations ⚡ **NEW**
2. **[Database Seeding Guide](DATABASE_SEEDING_GUIDE.md)** - System initialization ⚡
3. **[HTTP Requests Guide](HTTP_REQUESTS_GUIDE.md)** - Testing ⚡ **NEW**
4. HTTP Examples: `Archu.AdminApi/Archu.AdminApi.http` ⚡ **NEW**
...
├── docs/                                   # 📚 Documentation
│   ├── README.md                           # This file
│   ├── UPDATE_COMPLETE.md                  # Latest updates summary NEW
│   ├── ARCHU_API_DOCUMENTATION.md          # Complete API guide NEW
│   ├── ARCHU_API_QUICK_REFERENCE.md        # API quick reference NEW
│   ├── ADMIN_API_QUICK_REFERENCE.md        # Admin API reference NEW
│   ├── API_COMPARISON_GUIDE.md             # API comparison NEW
│   ├── HTTP_REQUESTS_GUIDE.md              # Testing guide NEW
│   ├── OPENAPI_UPDATE_SUMMARY.md           # OpenAPI update details NEW
│   ├── OPENAPI_DOCUMENTATION_UPDATE.md     # Admin API update details
│   ├── ARCHITECTURE.md                     # Architecture guide
│   ├── JWT_QUICK_START.md                  # 5-minute JWT setup ⚡
│   ├── JWT_CONFIGURATION_GUIDE.md          # Complete JWT reference
│   ├── DATABASE_SEEDING_GUIDE.md           # Database seeding guide
│   ├── PASSWORD_POLICY_GUIDE.md            # Password policy guide
...
│   ├── setup-jwt-secrets.ps1               # JWT setup (Windows)
│   └── setup-jwt-secrets.sh                # JWT setup (Linux/macOS)
├── src/
│   ├── Archu.Api/                          # 🌐 REST API
│   │   ├── Archu.Api.http                  # 40+ HTTP examples NEW
...
**[Learn more →](API_COMPARISON_GUIDE.md)**
...
**[Full guide →](HTTP_REQUESTS_GUIDE.md)**
...
- **API questions**: See [API Comparison Guide](API_COMPARISON_GUIDE.md) or [Archu API Documentation](ARCHU_API_DOCUMENTATION.md) ⚡ **NEW**
- **Testing questions**: See [HTTP Requests Guide](HTTP_REQUESTS_GUIDE.md) ⚡ **NEW**
