...
2. Run DocFX against this configuration:
   ...
   ```
3. Open the generated static site located at `docs/archu-ui/_site/index.html` in your browser.

DocFX uses the `Archu.Ui` project file as its metadata source, so any new XML comments added to components, pages, or services will automatically appear in the rendered documentation.
