# TentMan Integration Tests

## Overview

This project contains integration tests for the TentMan API using xUnit, WebApplicationFactory, and Testcontainers.
...
```bash
dotnet test tests\TentMan.IntegrationTests --filter "FullyQualifiedName~GetProductsEndpointTests"
```

### Run specific test method

```bash
dotnet test tests\TentMan.IntegrationTests --filter "GetProducts_ShouldReturn200OK_WithPagedProducts"
```
