...
using TentMan.Application.Auth.Commands.Register;
...
namespace TentMan.UnitTests.Application.Auth.Commands;
...
public class RegisterCommandHandlerTests
{
        ...
        Guid userId)
    {
        ...
        var command = new RegisterCommand(email, password, password, userName);
