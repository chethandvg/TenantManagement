...
public class ProductTests
{
    ...
    public void Product_ImplementsIAuditable()
    {
        ...
        // Act & Assert
        product.Should().BeAssignableTo<TentMan.Domain.Abstractions.IAuditable>();
    ...
    public void Product_ImplementsISoftDeletable()
    {
        ...
        // Act & Assert
        product.Should().BeAssignableTo<TentMan.Domain.Abstractions.ISoftDeletable>();
        product.IsDeleted.Should().BeFalse();
    }
    ...
    public void Product_ImplementsIHasOwner()
    {
        ...
        // Act & Assert
        product.Should().BeAssignableTo<TentMan.Domain.Abstractions.Identity.IHasOwner>();
