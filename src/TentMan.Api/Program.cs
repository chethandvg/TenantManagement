...
using TentMan.Api.Health;
using TentMan.Api.Middleware;
        ...
        document.Info = new()
        {
            ...
            Description = """
                ...
                **Token Refresh Flow:**
                ...
                - **GitHub Repository**: [https://github.com/chethandvg/tentman](https://github.com/chethandvg/tentman)
                - **HTTP Test File**: `src/TentMan.Api/TentMan.Api.http` (40+ example requests)
