...
using Archu.AdminApi.Middleware;
    ...
    options.AddDocumentTransformer((document, context, cancellationToken) =>
    {
        document.Info = new()
        {
            ...
            Description = """
                ...
                For detailed documentation, visit: [Admin API Documentation](https://github.com/chethandvg/archu/tree/main/docs)
                """,
            Contact = new()
            {
