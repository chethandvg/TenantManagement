        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Buildings_Organizations_OrgId",
                        column: x => x.OrgId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Files_Organizations_OrgId",
                        column: x => x.OrgId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Owners_Organizations_OrgId",
                        column: x => x.OrgId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BuildingAddresses_Buildings_BuildingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AreaSqFt = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    ...
                    HasUnitOwnershipOverride = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileTag = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BuildingFiles_Files_FileId",
                        column: x => x.FileId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuildingOwnershipShares", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BuildingOwnershipShares_Buildings_BuildingId",
                        column: x => x.BuildingId,
                        principalTable: "Buildings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BuildingOwnershipShares_Owners_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnitFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnitFiles_Files_FileId",
                        column: x => x.FileId,
                        principalTable: "Files",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UnitFiles_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsumerAccount = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnitMeters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnitMeters_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnitOwnershipShares", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnitOwnershipShares_Owners_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Owners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UnitOwnershipShares_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuildingAddresses_BuildingId",
                table: "BuildingAddresses",
                column: "BuildingId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BuildingAddresses_City",
                table: "BuildingAddresses",
                column: "City");

            migrationBuilder.CreateIndex(
                name: "IX_BuildingAddresses_PostalCode",
                table: "BuildingAddresses",
                column: "PostalCode");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuildingFiles_FileId",
                table: "BuildingFiles",
                column: "FileId");

            migrationBuilder.CreateIndex(
                name: "IX_BuildingOwnershipShares_BuildingId",
                table: "BuildingOwnershipShares",
                column: "BuildingId");

            migrationBuilder.CreateIndex(
                name: "IX_BuildingOwnershipShares_BuildingId_EffectiveTo",
                table: "BuildingOwnershipShares",
                columns: new[] { "BuildingId", "EffectiveTo" });

            migrationBuilder.CreateIndex(
                name: "IX_BuildingOwnershipShares_OwnerId",
                table: "BuildingOwnershipShares",
                column: "OwnerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Buildings_OrgId",
                table: "Buildings",
                column: "OrgId");

            migrationBuilder.CreateIndex(
                name: "IX_Buildings_OrgId_BuildingCode",
                table: "Buildings",
                columns: new[] { "OrgId", "BuildingCode" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Owners_LinkedUserId",
                table: "Owners",
                column: "LinkedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Owners_OrgId",
                table: "Owners",
                column: "OrgId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnitFiles_FileId",
                table: "UnitFiles",
                column: "FileId");

            migrationBuilder.CreateIndex(
                name: "IX_UnitFiles_UnitId",
                table: "UnitFiles",
                column: "UnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnitMeters_MeterNumber",
                table: "UnitMeters",
                column: "MeterNumber");

            migrationBuilder.CreateIndex(
                name: "IX_UnitMeters_UnitId",
                table: "UnitMeters",
                column: "UnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnitOwnershipShares_OwnerId",
                table: "UnitOwnershipShares",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_UnitOwnershipShares_UnitId",
                table: "UnitOwnershipShares",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_UnitOwnershipShares_UnitId_EffectiveTo",
                table: "UnitOwnershipShares",
                columns: new[] { "UnitId", "EffectiveTo" });
